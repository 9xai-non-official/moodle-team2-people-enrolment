-- Dependency: (baseline)  Issue: (none)  Reviewed-by: Essa
-- M01 — baseline schema + migration ledger.
-- schema.sql verbatim, preceded by the ledger table. No behaviour change.
-- schema.sql remains the human-readable "current full state", regenerated as
-- migrations merge; the source of change is this directory.
...
insert into schema_migrations(version) values ('M01') on conflict do nothing;
