...
-- M02 — baseline seed, verbatim and pre-corrections.
-- D-SEED (M09) corrects it forward; this file is never edited.
...
insert into schema_migrations(version) values ('M02') on conflict do nothing;
