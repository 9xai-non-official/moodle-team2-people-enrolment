-- ============================================================================
-- >> THIS FILE IS THE M01 BASELINE, NOT THE CURRENT STATE. <<
--
-- As of the migrations/ directory, the current full state is:
--     this file  +  everything in migrations/  (applied in order)
--
-- Do not edit this file to change the database — add a migration. Regenerating
-- this file to match the merged migrations is a separate step, tracked in the
-- work package's Definition of Done; until that lands, `migrations/apply.py
-- --status` is the authoritative answer to "what is in the database".
--
-- Already superseded below by migrations: v_course_progress (M03),
-- activity_completion's activity_id FK (M15), the plain-teacher
-- accessallgroups and non-manager course:view seed grants (M09), and fn_can,
-- which is DROPPED by M12.
-- ============================================================================
